...
namespace NGinn.Engine.Dao.Stubs {
  ...
  public class ProcessInstanceDb_Stub : SoodaObject {
    ...
    public System.Data.SqlTypes.SqlString ErrorInfo {
      ...
      set {
        Sooda.ObjectMapper.SoodaObjectImpl.SetPlainFieldValue(this, 0, "ErrorInfo", 8, Sooda.SoodaNullable.Box(value), new Sooda.SoodaFieldUpdateDelegate(this.BeforeFieldUpdate_ErrorInfo), new Sooda.SoodaFieldUpdateDelegate(this.AfterFieldUpdate_ErrorInfo));
      }
    }
