...
namespace NGinn.Worklist.BusinessObjects.Stubs {
  ...
  public class User_Stub : SoodaObject {
    ...
    private NGinn.Worklist.BusinessObjects.GroupList _collectionCache_Users = null;
    ...
    public GroupList Users {
      get {
        if ((this._collectionCache_Users == null)) {
          this._collectionCache_Users = new GroupList(new Sooda.ObjectMapper.SoodaObjectManyToManyCollection(this.GetTransaction(), 1, this.GetPrimaryKeyValue(), typeof(Users2Groups_RelationTable), Users2Groups_RelationTable.theRelationInfo));
        }
        return this._collectionCache_Users;
      }
    }
  ...
  public class Group_Stub : SoodaObject {
    ...
    internal NGinn.Worklist.BusinessObjects.GroupList _collectionCache_ChildGroups = null;
    private static Sooda.SoodaWhereClause _collectionWhere_ChildGroups = null;
    private NGinn.Worklist.BusinessObjects.UserList _collectionCache_Members = null;
    ...
    public GroupList ChildGroups {
      get {
        if ((this._collectionCache_ChildGroups == null)) {
          this._collectionCache_ChildGroups = new NGinn.Worklist.BusinessObjects.GroupList(new Sooda.ObjectMapper.SoodaObjectOneToManyCollection(this.GetTransaction(), typeof(Group), this, "Parent", Group_Factory.TheClassInfo, _collectionWhere_ChildGroups, false));
        }
        return this._collectionCache_ChildGroups;
      }
    }
    public UserList Members {
      get {
        if ((this._collectionCache_Members == null)) {
          this._collectionCache_Members = new UserList(new Sooda.ObjectMapper.SoodaObjectManyToManyCollection(this.GetTransaction(), 0, this.GetPrimaryKeyValue(), typeof(Users2Groups_RelationTable), Users2Groups_RelationTable.theRelationInfo));
        }
        return this._collectionCache_Members;
      }
    }
  ...
  public class Users2Groups_RelationTable : SoodaRelationTable {
    public static Sooda.Schema.RelationInfo theRelationInfo = NGinnWorklistBusinessObjects._DatabaseSchema.GetSchema().FindRelationByName("Users2Groups");
    public Users2Groups_RelationTable() : 
        base("Users2Groups", "user_id", "group_id", theRelationInfo) {
    }
  ...
  public class UserWrapperExpression : Sooda.QL.SoqlPathExpression {
    ...
    public virtual GroupCollectionExpression Users {
      get {
        return new GroupCollectionExpression(this, "Users");
      }
    }
  ...
  public class GroupWrapperExpression : Sooda.QL.SoqlPathExpression {
    ...
    public virtual GroupCollectionExpression ChildGroups {
      get {
        return new GroupCollectionExpression(this, "ChildGroups");
      }
    }
    public virtual UserCollectionExpression Members {
      get {
        return new UserCollectionExpression(this, "Members");
      }
    }
    public virtual Sooda.QL.TypedWrappers.SoqlInt32WrapperExpression Id {
      get {
...
namespace NGinn.Worklist.BusinessObjects.TypedQueries {
  ...
  public class UserField : object {
    ...
    public static GroupCollectionExpression Users {
      get {
        return new GroupCollectionExpression(null, "Users");
      }
    }
  ...
  public class GroupField : object {
    ...
    public static GroupCollectionExpression ChildGroups {
      get {
        return new GroupCollectionExpression(null, "ChildGroups");
      }
    }
    public static UserCollectionExpression Members {
      get {
        return new UserCollectionExpression(null, "Members");
      }
    }
    public static Sooda.QL.TypedWrappers.SoqlInt32WrapperExpression Id {
      get {
